...
import com.github.bpazy.mybatis.dom.model.TypeAlias;
import com.github.bpazy.mybatis.dom.model.TypeAliases;
...
public final class MapperUtils {
    ...
    public static void processConfiguredPackage(@NotNull Project project,
                                                @NotNull Processor<com.github.bpazy.mybatis.dom.model.Package> processor) {
        for (Configuration conf : getMybatisConfigurations(project)) {
            for (TypeAliases tas : conf.getTypeAliases()) {
                for (com.github.bpazy.mybatis.dom.model.Package pkg : tas.getPackages()) {
